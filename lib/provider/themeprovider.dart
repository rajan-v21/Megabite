...
class ThemeProvider with ChangeNotifier {
  ...
  ThemeData themeData() {
    return ThemeData(
      ...
      accentColor: isLightTheme ? Colors.blue : Colors.blue,
      primaryColor: isLightTheme ? Colors.blue : Color(0xFF1E1F28),
      brightness: isLightTheme ? Brightness.light : Brightness.dark,
      backgroundColor: isLightTheme ? Color(0xFFFFFFFF) : Color(0xFF141414),
      scaffoldBackgroundColor:
          isLightTheme ? Color(0xFFFFFFFF) : Color(0xFF141414),
    );
  }
